...
variable "db_instance_name"{
  type        = string
  default     = ""
  description = "DB instance identifier name to provided"
}
...
variable "db_subnet_group_name" {
  type        = string
  description = "Name of the database subnet group , if not provided terraform will assign random name"
  default     = ""
}

variable "vpc_filter_name" {
  description = "vpc filter to get the vpc id for list of subnets and from the output creating subnet group"
}